 ...
 * User can specify a list of implementation using config key
...
public interface INimbusCredentialPlugin extends Shutdownable {
     ...
     * This plugin will be called at least once during the submit Topology action.
     * It will be not be called during activate instead the credentials return by this method
     * will be merged with the other credentials in the topology and stored in
     * zookeeper.
     * 
