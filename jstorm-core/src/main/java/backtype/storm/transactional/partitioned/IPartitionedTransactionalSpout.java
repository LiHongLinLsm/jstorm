...
public interface IPartitionedTransactionalSpout<T> extends IComponent {
    public interface Coordinator {
         ...
         * it doesn't emit tuples for the new partition
         * because it knows how many partitions were in that transaction.
         */
        int numPartitions();

        /**
         * Returns true if its ok to emit start a new transaction,
         * false otherwise (will skip this transaction).
         * 
         * You should sleep here if you want a delay between asking for the next transaction
         * (this will be called repeatedly in a loop).
         */
        boolean isReady();
    ...
    public interface Emitter<X> {
        ...
        /**
         * Emit a batch of tuples for a partition/transaction that has been emitted before,
         * using the metadata created when it was first emitted.
         */
