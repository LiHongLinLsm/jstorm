 ...
 * 
 * You could specify the authorization plugin via storm parameter.
 * For example: storm -c nimbus.authorization.class=backtype.storm.security.auth.NoopAuthorizer
 * ...
 * 
