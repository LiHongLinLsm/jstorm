...
public interface IComponent extends Serializable {
     ...
     * 
     * @param declarer this is used to declare output stream ids,
     *                 output fields, and whether or not each output stream is a direct stream
     */
     ...
     * The component configuration can be further
